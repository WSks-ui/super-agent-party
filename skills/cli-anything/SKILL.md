---
name: cli-anything
description: Use when the user wants super agent party to build, refine, test, or validate a CLI-Anything harness for a GUI application or source repository. Adapts the CLI-Anything methodology to super agent party without changing the generated Python harness format.
---

# CLI-Anything for super agent party

Use this skill when the user wants super agent party to act like the `CLI-Anything` builder.
